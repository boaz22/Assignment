...
/* prepare statement */
if ($stmt = mysqli_prepare($link, "SELECT first_name,second_name,username,`password`,choice FROM users WHERE id = ?")) {
    mysqli_stmt_execute($stmt);
    mysqli_stmt_store_result($stmt);
    /* bind variables to prepared statement */
    mysqli_stmt_bind_result($stmt, $firstname,$secondname,$username,$password,$choice);
