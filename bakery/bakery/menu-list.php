...
.sidebar a:hover{
    ...
    <div class="menu">
        <h1>Apple Safaris land Menu</h1>
        <h2>Drinks</h2>
        <?php
            require_once("db_connect.php");

            $res= mysqli_query($link,"select * from land where land_type='Drinks'");
            echo "<table>";
            
            while($row=mysqli_fetch_array($res)){
                echo"<tr>";
                echo "<td>"; echo $row["land_id"] ;echo "</td>";
                echo "<td>";?> <img src="<?php echo $row["land_image"];?>" height="100" width="100"><?php echo "</td>";
                echo "<td>"; echo $row["land_size"] ;echo "</td>";
                echo "<td>"; echo $row["land_price"] ;echo "</td>";
                echo "<td>"
                ?>
                <input type="submit" name="update_land" value="update">
                <input type="submit" name="delete_land" value="delete">
        ...
        <?php
            ...
            $res= mysqli_query($link,"select * from land where land_type='Snack'");
            echo "<table>";
            
            while($row=mysqli_fetch_array($res)){
                echo"<tr>";
                echo "<td>"; echo $row["land_id"] ;echo "</td>";
                echo "<td>";?> <img src="<?php echo $row["land_image"];?>" height="200" width="400"><?php echo "</td>";
                echo "<td>"; echo $row["land_size"] ;echo "</td>";
                echo "<td>"; echo $row["land_price"] ;echo "</td>";
                echo "<td>";
                ?>
